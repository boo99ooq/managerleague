...
# 1. DEFINIZIONE DELLE FUNZIONI (Devono stare in alto)
def set_bg_image():
    st.markdown(
        f"""
        <style>
        .stApp {{
            background-image: url("http://googleusercontent.com/image_collection/image_retrieval/6863892888756412231_3");
        ...
        /* Forza il colore bianco per i testi */
...
# 2. CONFIGURAZIONE PAGINA E SFONDO
