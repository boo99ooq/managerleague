...
with t[4]: # VINCOLI
    ...
    if f_vn is not None:
        ...
        with v2:
            ...
            st.dataframe(det.style.format({c: "{:g}" for c in present_v if c != 'Giocatore'}).set_properties(**{'font-weight': 'bold'}, subset=['Giocatore']), hide_index=True, use_container_width=True)
