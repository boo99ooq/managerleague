...
<style>
    ...
    /* Forza il grassetto su tutte le celle delle tabelle */
    div[data-testid="stDataFrame"] * { color: #1a1a1a !important; font-weight: 900 !important; }
    ...
    /* Forza grassetto su testi generici */
    span, p, h1, h2, h3, label { font-weight: bold !important; }
</style>
...
with t[5]: # TAGLI
    ...
    if gioc_t:
        ...
        <div class="cut-box">
            ...
            VALUTAZIONE: <b>{int(v_p)}</b> | VINCOLI: <b>{int(v_v)}</b>
        </div>
        """, unsafe_allow_html=True)
