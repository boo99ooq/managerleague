...
# CSS CORRETTO (Evita SyntaxError)
st.markdown("""
<style>
...
# (Qui seguono le tab Classifiche, Budget, Rose, Vincoli, Scambi, Tagli come nel tuo app.py originale...)
# (Aggiungi in fondo la Tab Cessioni)
